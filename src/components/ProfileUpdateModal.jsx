...
function ProfileUpdateModal() {
    ...
    return (
        <>
            <Button variant="inline-dark" onClick={handleShow}>
                프로필 사진 수정하기
            </Button>

            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>프로필 사진을 추가 해주세요</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {/** 추가된 사진 미리보기 */}
                    <div ref={imgShow} style={{width:"150px", height:"150px",backgroundColor:"lightgray"}}></div>

                    {/** 사진 파인을 받아올 input태그 가져옴 */}
                ...
                <Modal.Footer>
                    ...
                    <Button variant="inline-dark" onClick={updateProfile}>
                        사진 저장
                    </Button>
                </Modal.Footer>
            </Modal>
